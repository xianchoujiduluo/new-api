...
var Version = "v0.0.0"            // may be overridden by VERSION for display compatibility
var BuildVersion = "v0.0.0"       // immutable release identity, replaced with -ldflags
var BuildCommit = "unknown"       // immutable source revision, replaced with -ldflags
